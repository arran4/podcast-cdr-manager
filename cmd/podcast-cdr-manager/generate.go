...
func (c *Iso) NewGenerate() *Generate {
	...
	set.BoolVar(&v.includeData, "include-data", false, "TODO: Add usage text")

	set.IntVar(&v.index, "index", 0, "TODO: Add usage text")

	set.StringVar(&v.outputDirectory, "output-directory", "", "TODO: Add usage text")
	set.Usage = v.Usage
